...
import com.github.glodblock.extendedae.api.IRecipeMachine;
...
import com.github.glodblock.extendedae.util.recipe.ContainerRecipeContext;
import com.github.glodblock.extendedae.util.recipe.RecipeExecutor;
import com.github.glodblock.extendedae.util.recipe.RecipeSearchContext;
...
public class TileCircuitCutter extends AENetworkPowerBlockEntity implements IGridTickable, IUpgradeableObject, IConfigurableObject, IRecipeMachine<Container, CircuitCutterRecipe> {
    ...
    public TileCircuitCutter(BlockPos pos, BlockState blockState) {
        super(FCUtil.getTileType(TileCircuitCutter.class, TileCircuitCutter::new, EAEItemAndBlock.CIRCUIT_CUTTER), pos, blockState);
        this.getMainNode()
                .setFlags()
                .setIdlePowerUsage(0)
    ...
    public TickingRequest getTickingRequest(IGridNode node) {
        return new TickingRequest(TickRates.Inscriber, !this.ctx.shouldTick() && !this.hasAutoExportWork(), false);
    }
